...
> > This is child.
> This should be treated as the same paragraph in the same quotation.`;
        const expect = `<blockquote><p>This is the test of blockquote.<br /><blockquote>This is child.<br /><blockquote>This is child's child.<br />This is child's child.</blockquote><br />This is child.</blockquote><br />This should be treated as the same paragraph in the same quotation.</p></blockquote>`;
        assert.equal(parser_1.parse(input), expect);
    });
  ...
  `;
    ...
    describe('Extention', () => {
        it('can be extended by user', () => {
            const plugins = {
                'extention': (args, content, mapper, join) => {
