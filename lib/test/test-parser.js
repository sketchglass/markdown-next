...
describe("parser", function () {
    ...
    it('should parse bold text inside a paragraph', function () {
        var input = "this should be **bold**";
        var expect = "<p>this should be <strong>bold</strong></p>";
        assert.equal(parser_1.parse(input), expect);
    });
    it('should parse bold text a single phrase', function () {
        var input = "**bold**";
        var expect = "<p><strong>bold</strong></p>";
        assert.equal(parser_1.parse(input), expect);
    });
