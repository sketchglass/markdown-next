...
var inline = P.alt(anchor, em, strong, plainStr);
...
var lists = ul.or(ol);
var acceptables = P.alt(h6, h5, h4, h3, h2, h1, lists, paragraphOrLinebreak, whitespace.result("<br />")).many().map(function (x) { return x.join(""); });
